...
int flag = 0;
String TalkBack_ID = "41017";         // Use you own TalkBack ID
String API_Key = "IS77MIECI2TYBG6Y";  // Use you own API Key
String postStr;
String uri;
String postMessage;
int led=13;
...
//請輸入自己WiFi熱點的名稱
#define SSID "HTC Portable Hotspot 09A3" // Use you own SSID

//請輸入自己WiFi熱點的密碼
#define PASS "8a298a1ed2a9" // Use you own Password
...
void setup() {
   ...
   uri = "/talkbacks/"+TalkBack_ID+"/commands?";
   postMessage = "api_key=IS77MIECI2TYBG6Y&command_string=LED_ON&position=1";
   // postStr = postCommand(uri, postMessage);
   postStr = "POST /talkbacks/41017/commands? HTTP/1.1\r\nHost: api.thingspeak.com\r\nContent-Type: application/x-www-form-urlencoded\r\nConnection: close\r\nContent-Length: 57\r\n\r\napi_key=IS77MIECI2TYBG6Y&command_string=LED_ON&position=1";
...
//    postMessage += "&headers=false";
    String Headers =  "POST " + uri + " HTTP/1.1\r\n" +
                    ...
                    "Content-Length: 57" +
                    "\r\n\r\n";
    Serial.println(Headers + postMessage);
    delay(1000);
